...
function validar_formulario() {
    ...
    provname=$("#providername").val();
    provphone=$("#providerphone").val();
    provemail=$("#providermail").val();
    empname=$("#companyname").val();
    empphone=$("#companyphone").val();
    empemail=$("#companymail").val();
    hora=$("#hora").val();
    ...
    if (provname === ""||provphone === ""||provemail === ""||empname === ""||empphone === ""||empemail === "") {
        ...
        alert("Se debe ingresar la hora de Disponibilidad");
        return false;
    }
